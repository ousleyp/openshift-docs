...
xref:../../virt/virtual_machines/virt-manage-virtual-machine-instances.adoc#virt-deleting-vmis-web_virt-manage-virtual-machine-instances[virtual machine instances],
